...
export const CATALOGO_PERMISSOES = [
  ...
  { codigo: 'checklist.ver', nome: 'Acessar AutoREV em loja', grupo: 'AutoREV', ordem: 26 },
  { codigo: 'checklist.executar', nome: 'Executar AutoREV e registrar visita', grupo: 'AutoREV', ordem: 28 },
