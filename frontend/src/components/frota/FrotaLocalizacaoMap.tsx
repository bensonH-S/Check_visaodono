...
export default function FrotaLocalizacaoMap({
  ...
  }, [posicoes, lojas, veiculos, mapaPronto, mobile, exibirPopupVeiculo, tecnicoDestaqueId, veiculoDestaqueId, lojaDestaqueId, visivel, consultaHistorico, trajetoDiaAtual, corVeiculoPorId]);
